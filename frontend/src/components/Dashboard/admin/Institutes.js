...
const Institutes = () => {
  ...
  const handleAddInstitute = async (e) => {
    ...
    try {
      const response = await axios.post("https://backenderp-production-6374.up.railway.app/api/admin/institutes", newInstitute);
  ...
  const handleDeleteInstitute = async (id) => {
    ...
    try {
      await axios.delete(`https://backenderp-production-6374.up.railway.app/api/admin/institutes/${id}`);
  ...
  const handleSave = async (id) => {
    try {
      const response = await axios.put(
        `https://backenderp-production-6374.up.railway.app/api/admin/institutes/${id}`,
        editInstitute
      );
      setInstitutes((prev) =>

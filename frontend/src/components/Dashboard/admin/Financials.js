...
const Financials = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        const response = await axios.get("https://backenderp-production-6374.up.railway.app/api/admin/financials");
  ...
  const handleAddTransaction = async (e) => {
    ...
    try {
      const response = await axios.post("https://backenderp-production-6374.up.railway.app/api/admin/financials", newTransaction);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://backenderp-production-6374.up.railway.app/api/admin/financials/${id}`);
  ...
  const handleSave = async (id) => {
    try {
      const response = await axios.put(
        `https://backenderp-production-6374.up.railway.app/api/admin/financials/${id}`,
        editTransaction
      );

...
export default function Notifications() {
  ...
  const loadNotifications = async () => {
    try {
      const res = await axios.get(
        "https://backenderp-production-6374.up.railway.app/api/institute/notifications/all"
      );
  ...
  const handleAdd = async (e) => {
    ...
    try {
      await axios.post(
        "https://backenderp-production-6374.up.railway.app/api/institute/notifications/send",
        payload
      );
